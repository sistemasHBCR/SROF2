...
<head>
    ...
    <title>Cambiar contraseña | SRO</title>
                    ...
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" method="POST"
                            ...
                            <div class="mb-3 form-password-toggle">
                                <label class="form-label" for="password">Dirección de correo electrónico</label>
                                <div class="input-group input-group-merge">
                                    <input type="email" id="email" value="{{ $request->email }}"
                            ...
                            <button type="submit" class="btn btn-primary d-grid w-100 mb-3">Establecer nueva
                                contraseña</button>
                        </form>
                    </div>
                </div>
