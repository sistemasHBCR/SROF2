...
<head>
    ...
    <script src="{{ asset('assets/jsv3/config.js') }}"></script>
</head>
...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo h3 mb-0 fw-bold">SRO</span>
                            </a>
                        </div>
                        <div class="app-brand justify-content-center">
                            <div class="avatar avatar-xl">
                                <img src="../../logo-dark.png" alt="image" data-app-light-img="../../../../logo.png"
                        ...
                        <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('login') }}">
                            ...
                            <!-- Email Address -->
                            <div class="mb-3">
                                <label for="email" class="form-label">CORREO ELECTRÓNICO O
                                    NOMBRE DE
                                    USUARIO</label>
                                <input type="text"
                                    class="form-control @error('email-username') is-invalid @enderror"
                                    id="email_username" name="email_username" value="{{ old('email_username') }}"
                                    placeholder="Introduce tu correo o nombre de usuario" autofocus />
                            ...
                            <div class="mb-3">
                                ...
                                <div class="divider divider-dashed">
                                    <div class="divider-text mb-1">O</div>
                                    <li class="list-group-item d-flex justify-content-center">
                                        <button type="button" class="btn btn-outline-primary"
                                            onclick="window.location.href='/'">Cambiar sitio<i
                                                class="bx bx-exit me-1"></i></button>
                                    </li>
                                </div>
                            </div>
                        </form>
    ...
    <!-- Main JS -->
    <script src="{{ asset('assets/jsv3/main.js') }}"></script>

    <!-- Page JS -->
    <script src="{{ asset('assets/jsv3/pages-auth.js') }}"></script>
