...
<head>
    ...
    <title>Reset Contraseña | SRO</title>
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Ingresa tu email y te enviaremos instrucciones para restablecer tu contraseña
                        </p>
                        ...
                        @error('email')
                            <div class="alert alert-danger alert-dismissible d-flex align-items-center" role="alert">
                                <i class="bx bx-xs bx-error me-2"></i>
                                {{ $message }}
                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                            </div>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('password.email') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    ...
                                    placeholder="Introduce tu correo electrónico" autofocus required />
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <button type="submit" class="btn btn-primary d-grid w-100">Enviar enlace</button>
                        </form>
