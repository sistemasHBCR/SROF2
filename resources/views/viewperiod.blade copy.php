...
@section('contenido')
    <div class="container-xxl flex-grow-1 container-p-y">
                                        ...
                                        <tbody>
                                            @foreach ($residences as $residence)
                                                <tr row="{{ $residence->id }}">
                                                    ...
                                                    <td><a class="bx bx-check text-success bx-sm me-2"></a></td>
                                                    <td><a class="bx bx-check text-success bx-sm me-2"></a></td>
        ...
        <div class="modal fade" id="Modal-Utilities" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
                            ...
                            <div class="bs-stepper-header border-0 p-1">
                                <div class="step" data-target="#luz">
                                    <button type="button" class="step-trigger">
                                        <span class="bs-stepper-circle"><i class="fa-solid fa-lightbulb"></i></span>
                                ...
                                <div class="step" data-target="#agua">
                                    <button type="button" class="step-trigger">
                                        <span class="bs-stepper-circle"><i class="fa-solid fa-droplet"></i></span>
                                        <span class="bs-stepper-label">
                                ...
                                <!--
                                                                        ...
                                                                        <div class="step" data-target="#submit">
                                                                            <button type="button" class="step-trigger">
                                                                                ...
                                                                                <span class="bs-stepper-label">
                                                                                    <span class="bs-stepper-title text-uppercase">Guardar</span>
                                                                                    <span class="bs-stepper-subtitle">Registro</span>
                                                                                </span>
                                                                            </button>
                                                                        </div>
                                                                    -->
                            ...
                            <div class="bs-stepper-content p-1">
                                <form onSubmit="return false">
                                    ...
                                    <div id="luz" class="content pt-3 pt-lg-0">
                                        <div class="mb-3">
                                            <input type="text" class="form-control form-control-lg" id="captureluz"
                                                placeholder="Consumo" />
                                        </div>
                                                ...
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                                ...
                                                                <div class="carousel-inner">
                                                                    <div class="carousel-item active">
                                                                        ...
                                                                        <div class="carousel-caption d-none d-md-block">
                                                                            <h3>First slide</h3>
                                                                            <p>Eos mutat malis maluisset et, agam ancillae
                                                                                quo te, in vim congue pertinacia.</p>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="carousel-item">
                                                                        ...
                                                                        <div class="carousel-caption d-none d-md-block">
                                                                            <h3>Third slide</h3>
                                                                            <p>Lorem ipsum dolor sit amet, virtute consequat
                                                                                ea qui, minim graeco mel no.</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <a class="carousel-control-prev"
                                                                    href="#carouselExampleDark" role="button"
                                                                    data-bs-slide="prev">
                                                        ...
                                                        <div class="row mb-3 g-3">
                                                            <div class="col-6">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="mb-0 text-nowrap">17 Nov 23 12:30 pm
                                                                        </h6>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="mb-0 text-nowrap">Ulises sosa</h6>
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-primary w-100">Comparar captura anterior</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="agua" class="content pt-3 pt-lg-0">
                                        <div class="mb-3">
                                            <input type="text" class="form-control form-control-lg" id="captureagua"
                                                placeholder="Consumo" />
                                        </div>
                                        <h5 class="text-center">CAPTURA</h5>
                                        <div class="card-group mb-5">
                                            <div class="col-12 col-xl-12 col-md-12">
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                        <div class="bg-label-secondary rounded-3 text-center mb-3 ">
                                    ...
                                    <div id="gas" class="content pt-3 pt-lg-0">
                                        <div class="mb-3">
                                            <input type="text" class="form-control form-control-lg" id="capturegas"
                                                placeholder="Consumo" />
                                        </div>
                                        <h5 class="text-center">CAPTURA</h5>
                                        <div class="card-group mb-5">
                                        ...
                                        <div id="AppNewCCForm" class="row g-3 pt-3 pt-lg-0 mb-5" onsubmit="return false">
                                            <div class="col-12">
                                                <div class="input-group input-group-merge">
                                                    <input class="form-control app-credit-card-mask" type="text"
                                                        placeholder="1356 3215 6548 7898"
                                                        aria-describedby="modalAppAddCard" />
                                                    <span class="input-group-text cursor-pointer p-1"
                                                        id="modalAppAddCard"><span class="app-card-type"></span></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6 col-md-3">
                                                <input type="text" class="form-control app-expiry-date-mask"
                                                    placeholder="MM/YY" />
                                            </div>
                                            <div class="col-6 col-md-3">
                                                <div class="input-group input-group-merge">
                                                    <input type="text" id="modalAppAddCardCvv"
                                                        class="form-control app-cvv-code-mask" maxlength="3"
                                                        placeholder="654" />
                                                    <span class="input-group-text cursor-pointer"
                                                        id="modalAppAddCardCvv2"><i class="text-muted bx bx-help-circle"
                                    ...
                                    <div id="submit" class="content text-center pt-3 pt-lg-0 mb-2">
                                        <p>Los campos vacios no se guardaran y quedaran registrados como pendientes por
                                            capturar</p>

                                        <img src="{{ asset('assets/img/illustrations/utilities.png') }}" width="300"
                                            class="img-fluid" data-app-light-img="illustrations/utilities.png"
